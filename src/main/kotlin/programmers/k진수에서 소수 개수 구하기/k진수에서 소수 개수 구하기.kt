package programmers.`k진수에서 소수 개수 구하기`
...
fun main() {
    ...
    println(solution.solution(n = 437674, k = 3))
}
...
//            }
//        }
//        str.reverse().split("0").map {
//
//        }
//
//        n.toString().map {
//            stack.add(Character.getNumericValue(it))
//        }
...
/*
양의 정수 n이 주어지는데 이 숫자를 k 진수로 바꿨을 때 ,변환된 수 안에 아래 조건에 맞는 소수(PrimeNumber)가
몇개 인지 알아보려한다
- 0P0 처럼 소수 양쪽에 0이 있는 경우
- P0처럼 소수 오른쪽에만 0이 있고 왼쪽에는 아무것도 없는 경우
- OP처럼 소수 왼쪽에만 0이 있고 오른쪽에는 아무것도 없는 경우
- P처럼 소수 양쪽에 아무것도 없는 경우
- 단 P는 각 자릿수에 0을 포함하지 않는 소수다.
  101 은 소수 P가 될 수 없다.

437674 -> 3 진수로 바꿧을 때 211020101011
 */
